...
8-2.![alt text](https://commons.wikimedia.org/wiki/File:Markdown-mark.svg "Markdownlogo")
8-3.<img width="00px" height="00px"></img>
```

![Markdown](../images/2025-07-30-markdown/markdownlogo.png "Markdownlogo")<br>
![alt text](https://commons.wikimedia.org/wiki/File:Markdown-mark.svg "Markdownlogo")<br>
