...
![sturcture]({{ site.baseurl }}/images/project/250923_bookmarket_2.png "bookmarket's sturcture")

## 2.welcome.jsp - menu.jsp, footer.jsp

 ![welcome.jsp]({{ site.baseurl }}/images/project/250923_bookmarket_1.png "welcome.jsp")

### 2-1. Include Directive
    (1) menu.jsp - <%@ include file="menu.jsp" %>
    (2) footer.jsp - <%@ include file="menu.jsp" %>
